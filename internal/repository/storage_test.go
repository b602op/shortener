...
// // TODO вернуть с оптимизацией // TestStorage_Init_LoadExistingFile проверяет загрузку из существующего файла
...
// // TODO без оптимизации: TestStorage_Init_LoadExistingFile проверяет загрузку из существующего файла
// func TestStorage_Init_LoadExistingFile(t *testing.T) {
// 	testFile := "test_storage_load.json"
// 	defer os.Remove(testFile)
